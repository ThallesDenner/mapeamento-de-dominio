# Mapeamento de Domínio para Sistema de Gerenciamento de Estoque
...
Dialógo retirado de [Rocketseat](https://efficient-sloth-d85.notion.site/Atividade-Mapeando-o-dom-nio-38963358ffd74289b824ff73b187165d).
...
- Rastrear produto por id
- Rastrear produto por meio de filtros (características do produto tais como tamanho, cor, etc.)
- Definir quantidade mínima do produto em estoque
- Enviar mensagem para o email quando a quantidade do produto em estoque for menor ou igual ao mínimo  
- Enviar notificação no sistema de gerenciamento de estoque quando a quantidade do produto em estoque for menor ou igual ao mínimo   
- Obter histórico de venda dos produtos por período
  - Visualizar a quantidade total de produtos vendidos
  - Visualizar o lucro total
  - Visualizar a quantidade vendida por produto
  - Visualizar lucro por produto
  - Visualizar taxa de crescimento das vendas de cada produto: TCV = ((Vendas no Período Atual - Vendas no Período Anterior) / Vendas no Período Anterior) * 100
- Obter histórico da quantidade de cada produto em estoque 
- Gerar ordem de compra automaticamente com base nas quantidades mínimas de estoque definidas e nas tendências de vendas 
- Permitir a criação manual de ordem de compra
- Receber atualizações automáticas sobre os prazos de entrega de novas remessas de fornecedores
